  ...
  return (
    <div className={containerClasses}>
      ...
      <motion.div
        ...
        className="relative w-full max-w-[340px] mb-6 md:max-w-[400px] md:mb-8 lg:max-w-[480px] lg:mb-10 tv:max-w-[600px] tv:mb-0 tv:flex-shrink-0"
      >
        {/* Outer glow ring */}
        <motion.div
          animate={{
      ...
      <div className="flex flex-col items-center w-full tv:flex-1 tv:items-start relative z-10">
        ...
        <motion.div
          ...
          className="text-center mb-6 md:mb-8 tv:text-left tv:mb-10"
        >
          <h2 className="text-2xl font-bold mb-2 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent md:text-3xl lg:text-4xl tv:text-5xl">
            {currentStation.name}
          </h2>
          {metadata && (
            <motion.p
              ...
              className="text-white/70 font-medium text-sm md:text-base lg:text-lg tv:text-2xl"
            >{metadata}</motion.p>
          )}
        </motion.div>
        ...
        <motion.button
          ...
          disabled={isLoading}
          tabIndex={0}
          className="relative rounded-full disabled:opacity-50 group tv-focusable w-16 h-16 mb-6 md:w-20 md:h-20 md:mb-8 lg:w-24 lg:h-24 tv:w-32 tv:h-32 tv:mb-12"
        >
        ...
        <div className={`relative w-full h-full rounded-full backdrop-blur-xl border-2 border-white/30 shadow-2xl flex items-center justify-center group-hover:border-white/50 transition-colors ${
          ...
          {isLoading ? (
            ...
            <svg className="w-8 h-8 text-white drop-shadow-lg md:w-10 md:h-10 lg:w-12 lg:h-12 tv:w-16 tv:h-16" fill="currentColor" viewBox="0 0 24 24">
              <path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z" />
            </svg>
          ) : (
            <svg className="w-8 h-8 text-white ml-1 drop-shadow-lg md:w-10 md:h-10 md:ml-1 lg:w-12 lg:h-12 lg:ml-2 tv:w-16 tv:h-16 tv:ml-3" fill="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div
          ...
          className="flex gap-2 w-full mb-5 max-w-xs md:gap-3 md:max-w-sm md:mb-6 lg:max-w-md lg:gap-4 tv:max-w-2xl tv:gap-6 tv:mb-8"
        >
        ...
        {streamInfo && (
          <motion.div
            ...
            className="flex items-center justify-center gap-2 text-primary font-medium text-xs md:gap-3 md:text-sm lg:text-base lg:gap-4 tv:text-xl tv:gap-6"
          >
