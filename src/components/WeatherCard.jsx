...
const PhosphorIcons = {
  Sun: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M120 40V16a8 8 0 0 1 16 0v24a8 8 0 0 1-16 0Zm72 88a64 64 0 1 1-64-64 64.07 64.07 0 0 1 64 64Zm-16 0a48 48 0 1 0-48 48 48.05 48.05 0 0 0 48-48ZM58.34 69.66a8 8 0 0 0 11.32-11.32l-16-16a8 8 0 0 0-11.32 11.32Zm0 116.68-16 16a8 8 0 0 0 11.32 11.32l16-16a8 8 0 0 0-11.32-11.32ZM192 72a8 8 0 0 0 5.66-2.34l16-16a8 8 0 0 0-11.32-11.32l-16 16A8 8 0 0 0 192 72Zm5.66 114.34a8 8 0 0 0-11.32 11.32l16 16a8 8 0 0 0 11.32-11.32ZM48 128a8 8 0 0 0-8-8H16a8 8 0 0 0 0 16h24a8 8 0 0 0 8-8Zm80 80a8 8 0 0 0-8 8v24a8 8 0 0 0 16 0v-24a8 8 0 0 0-8-8Zm112-88h-24a8 8 0 0 0 0 16h24a8 8 0 0 0 0-16Z"/></svg>
  ),
  Moon: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M233.54 142.23a8 8 0 0 0-8-2 88.08 88.08 0 0 1-109.8-109.8 8 8 0 0 0-10-10 104.84 104.84 0 0 0-52.91 37A104 104 0 0 0 136 224a103.09 103.09 0 0 0 62.52-20.88 104.84 104.84 0 0 0 37-52.91 8 8 0 0 0-1.98-7.98Zm-44.64 48.11A88 88 0 0 1 65.66 67.11a89 89 0 0 1 31.4-26A106 106 0 0 0 96 56a104.11 104.11 0 0 0 104 104 106 106 0 0 0 14.92-1.06 89 89 0 0 1-26.02 31.4Z"/></svg>
  ),
  Cloud: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M160 40a88.09 88.09 0 0 0-78.71 48.67A64 64 0 1 0 72 216h88a88 88 0 0 0 0-176Zm0 160H72a48 48 0 0 1 0-96c1.1 0 2.2 0 3.29.11A88 88 0 0 0 72 128a8 8 0 0 0 16 0 72 72 0 1 1 72 72Z"/></svg>
  ),
  CloudRain: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M158.66 196.44 153 213.17a8 8 0 1 1-15.27-4.94l5.66-16.73a8 8 0 0 1 15.27 4.94Zm-40 0a8 8 0 0 0-10.22 4.89l-5.66 16.73a8 8 0 1 0 15.27 4.94l5.66-16.73a8 8 0 0 0-5.05-10.83Zm-40 0a8 8 0 0 0-10.22 4.89l-5.66 16.73a8 8 0 1 0 15.27 4.94l5.66-16.73a8 8 0 0 0-5.05-10.83ZM228 92a76.08 76.08 0 0 1-76 76H76A52 52 0 1 1 86.2 64.37 76.09 76.09 0 0 1 228 92Zm-16 0a60.07 60.07 0 0 0-120-1.07A8 8 0 0 1 84 96a76.2 76.2 0 0 1-1.14 13 8 8 0 0 1-7.76 6.36A36 36 0 0 0 76 152h76a60.07 60.07 0 0 0 60-60Z"/></svg>
  ),
  Lightning: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M213.85 125.46l-112 120a8 8 0 0 1-13.69-7.3l16.79-73.27l-51.78-17.26a8 8 0 0 1-1.43-14.69l112-64a8 8 0 0 1 11.87 9.43l-17.45 76.09l52.34-17.45a8 8 0 0 1 3.35-15.55Z"/></svg>
  ),
  Snowflake: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M223.72 120.53 184 104l39.72-16.53a8 8 0 1 0-6.31-14.73L184 88.63V56a8 8 0 0 0-16 0v32.63l-33.41-15.89a8 8 0 1 0-6.31 14.73L168 104l-39.72 16.53a8 8 0 0 0 0 14.73L168 152l-39.72 16.53a8 8 0 1 0 6.31 14.73L168 167.37V200a8 8 0 0 0 16 0v-32.63l33.41 15.89a8 8 0 1 0 6.31-14.73L184 152l39.72-16.53a8 8 0 1 0 0-14.73ZM72 200a8 8 0 0 0 16 0v-32.63l33.41 15.89a8 8 0 1 0 6.31-14.73L88 152l39.72-16.53a8 8 0 0 0 0-14.73L88 104l39.72-16.53a8 8 0 1 0-6.31-14.73L88 88.63V56a8 8 0 0 0-16 0v32.63L38.59 72.74a8 8 0 1 0-6.31 14.73L72 104l-39.72 16.53a8 8 0 1 0 0 14.73L72 152l-39.72 16.53a8 8 0 1 0 6.31 14.73L72 167.37Z"/></svg>
  ),
  Drop: () => (
    <svg viewBox="0 0 256 256" className="w-full h-full"><path fill="currentColor" d="M174 47.75a254.19 254.19 0 0 0-41.45-38.3 8 8 0 0 0-9.18 0A254.19 254.19 0 0 0 82 47.75C54.51 79.32 40 112.6 40 144a88 88 0 0 0 176 0c0-31.4-14.51-64.68-42-96.25ZM128 216a72.08 72.08 0 0 1-72-72c0-57.23 55.47-105 72-118c16.53 13 72 60.75 72 118a72.08 72.08 0 0 1-72 72Z"/></svg>
  ),
  MapPin: () => (
