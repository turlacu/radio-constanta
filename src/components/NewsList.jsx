      ...
      {hasMore && (
        ...
        >
          <motion.button
            ...
            className={
              isSplitScreen
                ? "relative max-w-xs mx-auto block font-normal overflow-hidden disabled:opacity-50 group tv-focusable py-2.5 px-6 rounded-xl text-xs" // Smaller button with horizontal padding to prevent text overflow
