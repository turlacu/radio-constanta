      ...
      {hasMore && (
        ...
        >
          <motion.button
            ...
            className={
              isSplitScreen
                ? "relative max-w-xs mx-auto block font-normal overflow-hidden disabled:opacity-50 group tv-focusable py-2.5 rounded-xl text-xs" // Smaller, centered button with normal font weight
